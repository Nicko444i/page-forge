...
${TYPES_DOC}
- Always include a "rich_text" section for the product description/story paragraph (the descriptive text after the opening, e.g. "A Smarter Way to..."). Do NOT merge it into the hero.
- Keep every distinct headed block as its OWN section. Do NOT merge multiple benefit lists or separate sections into one; if the source text has several headed blocks, output a section for each.
